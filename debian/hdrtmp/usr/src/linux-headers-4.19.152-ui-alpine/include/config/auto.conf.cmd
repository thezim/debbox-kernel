deps_config := \
	...
	drivers/net/ethernet/al/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-gnu-gcc (Debian 6.3.0-18) 6.3.0 20170516"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
